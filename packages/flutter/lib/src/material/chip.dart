...
final ColorFilter _kIconColorFilter =
    new ColorFilter.mode(Colors.black54, TransferMode.dstIn);

class Chip extends StatelessComponent {
  const Chip({Key key, this.avatar, this.label, this.onDeleted})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    children.add(new DefaultTextStyle(style: _kLabelStyle, child: label));
    ...
    return new Container(
        ...
        decoration: new BoxDecoration(
            backgroundColor: Colors.grey[300], borderRadius: 16.0),
